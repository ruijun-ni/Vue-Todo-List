<template>
  <div class="auth">
    ...
    <template v-if="!user">
      <button class="button is-primary is-small" @click="signInWithGoogle"> Sign in with Google </button>
    </template>
    <template v-if="user">
      ...
      <button class="button is-primary is-outlined is-small" @click="signOut">Sign Out</button>
    </template>
